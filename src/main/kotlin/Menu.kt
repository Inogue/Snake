    ...
    private fun createLayout(vararg arg: JComponent) {
        ...
        gl.setHorizontalGroup(
            gl.createParallelGroup(GroupLayout.Alignment.CENTER).addComponent(arg[0]).addGap(60, 150, Integer.MAX_VALUE)
                .addComponent(arg[1]).addComponent(arg[2]).addComponent(arg[3])
        )

        gl.setVerticalGroup(
            gl.createSequentialGroup().addComponent(arg[0]).addGap(30).addComponent(arg[1]).addComponent(arg[2])
                .addComponent(arg[3])
        )
        pack()
    }
